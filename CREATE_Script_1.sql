...
album_label varchar(80) NULL,
album_duration integer NULL,
album_release_year integer CHECK (album_release_year BETWEEN 1920 AND 2050) NULL   -- (album_release_year > 1920 AND album_release_year < 2050) NULL
);

CREATE TABLE IF NOT EXISTS tracks (
track_id serial PRIMARY KEY,
track_title varchar(80) NOT NULL,
track_duration integer CHECK (track_duration BETWEEN 10 AND 1800) NOT NULL 
);
